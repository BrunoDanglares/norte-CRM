// Portado verbatim do nexus-react@3.3.0 (admin-layout/SidebarMenuItemBadges).
        ...
        <div className="ms-auto inline-flex gap-2">
            {badges.map((badge) => {
                ...
                return (
                    <div
                        key={badge}
                        className="bg-primary text-primary-content rounded-box ms-0 px-1.5 text-[12px] font-semibold">
                        {badge}
                    </div>
                );
            })}
